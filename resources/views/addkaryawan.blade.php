...
<body>
    ...
    <div class="box">
        <h1>Add Employee</h1>
        <form action="/add-karyawan1" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="Age" aria-describedby="emailHelp" name="Age" value="{{ old('Age')}}">
                @error('Age')
            ...
            <div class="mb-3">
                ...
                @error('Address')
                    <p style="color: red;">{{ 'Address field is required.' }}</p>
                @enderror
            </div>  
            <div class="mb-3">
                <label for="Phone" class="form-label">Phone Number</label>
                <input type="number" class="form-control" id="Phone" aria-describedby="emailHelp" name="Phone" value="{{ old('Phone')}}">
                @error('Phone')
                    <p style="color: red;">{{ 'Phone number field is required.' }}</p>
                @enderror
            </div>
            <div class="mb-3">
